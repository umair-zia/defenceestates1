                    ...
                    <div class="property-detail">
                        ...
                        <div class="property-features">
                            ...
                            <ul class="list-style-one">
                                ...
                                <li style="color: #FFFFFF;">Area: <?php echo e($ad->area); ?> <?php echo e($ad->unit); ?><sup><a class="la la-info-circle" data-toggle="popover" title="Area Conversion" data-content="Marla: (Some Values)"> </a></sup></li>
                ...
                <div class="sidebar-side col-lg-4 col-md-12 col-sm-12">
                    <aside class="sidebar default-sidebar">
                        ...
                        <div class="sidebar-widget categories">
                            ...
                            <ul class="cat-list">
                                <li><a href="#">Apartments <span><?php echo e($ad->where('category', 'Apartments')->count()); ?></span></a></li>
                                <li><a href="#">Commercial <span><?php echo e($ad->where('category', 'Commercial')->count()); ?></span></a></li>
                                <li><a href="#">Homes <span><?php echo e($ad->where('category', 'Homes')->count()); ?></span></a></li>
                                <li><a href="#">Plots <span><?php echo e($ad->where('category', 'Plots')->count()); ?></span></a></li>
                                <li><a href="#">Farm House <span><?php echo e($ad->where('category', 'Farm House')->count()); ?></span></a></li>
                            </ul>
                        </div>
...
<?php echo $__env->make('layouts.ads', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/blackfire/Desktop/proj_05/defenceEstate1 (copy)/resources/views/ads/show.blade.php ENDPATH**/ ?>