                                                ...
                                                <div class="title" style="background-color: #2f4f4f"><h3>Update File Info</h3></div>
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-lg-3 col-md-6 col-sm-12">
                                                            ...
                                                            <input type="text"  placeholder="Phase" name="phase" value="<?php echo e(isset($file) ? $file->block : ''); ?>" required>
                                                        </div>
                                                        ...
                                                        <div class="form-group col-lg-3 col-md-6 col-sm-12">
                                                            ...
                                                            <select name="fileType" id="">
                                                                ...
                                                                <option value="">Commercial File</option>
                                                                <option value="">Residential File</option>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <!-- Form Group -->
                                                        <div class="form-group col-lg-3 col-md-6 col-sm-12">
                                                            <button type="submit" class="theme-btn btn-style-one" style="background: #2f4f4f;">Edit File</button>
                                                        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\22-10-20\defenceEstate1\resources\views/admin/update-file.blade.php ENDPATH**/ ?>