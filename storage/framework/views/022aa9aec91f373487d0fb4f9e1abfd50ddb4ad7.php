        ...
        <div class="header-top">
            <div class="auto-container">
                <div class="inner-container clearfix">
                    ...
                    <div class="top-right">
                        <div class="btn-box"><a href="<?php echo e(route('admin.index')); ?>" class="theme-btn btn-style-four">Submit Property</a></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="property-block col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box">
                                ...
                                <?php if(isset($img)): ?>
                                    <div class="image-box">
                                        <a href="<?php echo e(route('ads.show',['id' => $ad->id ])); ?>">
                                            <figure class="image"><img src="<?php echo e(asset('storage/properties').'/'.$img); ?>" alt=""></figure>
                                        </a>
                                    </div>
                                <?php endif; ?>
                            <?php endif; ?>
                        ...
                        <div class="lower-content">
                            ...
                            <div class="lucation"><i class="la la-map-marker"></i><?php echo e($ad->adress); ?></div>
                            <ul class="property-info clearfix">
                            <?php if($ad->unit == 'Marla'): ?>
                            <li><i class="flaticon-dimension"></i><?php echo e($ad->area); ?> Marla
                                <?php else: ?>
                                    <?php if($ad->unit != 'Marla'): ?>
                                        <?php if($ad->unit == 'Square Feet'): ?>
                                        <li><i class="flaticon-dimension"></i><?php echo e(round($ad->area/225, 2)); ?> Marla
                                            <sup>
                                        ...
                                        <li><i class="flaticon-dimension"></i><?php echo e(round($ad->area/25, 2)); ?> Marla
                                            <sup>
                                                <a class="la la-info-circle" 
                                                data-toggle="popover" 
                                                title="Area Conversion" 
                                        ...
                                        <li><i class="flaticon-dimension"></i><?php echo e(round($ad->area/20.9, 2)); ?> Marla
                                            <sup>
                                                <a class="la la-info-circle" 
                                                data-toggle="popover" 
                                                title="Area Conversion" 
                                        ...
                                        <li><i class="flaticon-dimension"></i><?php echo e($ad->area*20); ?> Marla
                                            <sup>
                                                <a class="la la-info-circle" 
                                                data-toggle="popover" 
                                                title="Area Conversion" 
                                ...
                                <li><i class="flaticon-bed"></i> <?php echo e($ad->bedroom); ?> Bedrooms</li>
                                <li><i class="flaticon-full-screen"></i> <?php echo e($ad->kitchen); ?> Kitchen</li>
                                <li><i class="flaticon-bathtub"></i> <?php echo e($ad->bathroom); ?> Bathroom</li>
                            </ul>
                            <div class="property-price clearfix">
                                <div class="read-more"><a href="<?php echo e(route('ads.show',['id' => $ad->id ])); ?>" class="theme-btn btn-style-two">More Detail</a></div>
...
<?php /**PATH C:\Users\Umair Zia\Documents\defence\v2\defenceEstate1\resources\views/index.blade.php ENDPATH**/ ?>