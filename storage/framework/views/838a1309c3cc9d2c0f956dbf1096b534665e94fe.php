...
<div class="page-wrapper">
            ...
            <div class="auto-container">
                <div class="inner-container clearfix">
                    ...
                    <div class="top-right clearfix">
                        ...
                        <div class="btn-box">
                            <a href="<?php echo e(route('ads.create')); ?>" class="theme-btn btn-style-two" style="background: #26b3fb">Add Property</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <nav class="main-menu navbar-expand-md navbar-dark">
                            ...
                            <div class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    ...
                                    <li class="dropdown"><a href="#">Files</a>
                                        <ul>
                                    ...
                                    <li><a href="https://maps.dhalahore.org/" target="_blank">DHA GIS Map</a></li>
    ...
    <?php echo $__env->yieldContent('content'); ?>
        <!-- Main Footer -->
        <footer class="main-footer style-three mt-1">
        <div class="auto-container">
            <div class="upper-box">
                <div class="row">
                    <!-- Upper column -->
...
</html><?php /**PATH C:\xampp\htdocs\Laravel\defenceEstate1\defenceEstate1\resources\views/layouts/ads.blade.php ENDPATH**/ ?>