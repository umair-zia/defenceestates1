...
<script>
    ...
    function drawVisualization<?php echo e($file->id); ?>() {
        ...
        chart.draw(data, {title: '<?php echo e($file->id); ?>',
            ...
            <div class="mixitup-gallery">
                ...
                <div class="filter-list row">
                    ...
                    <div class="property-block all mix lahore commercial col-xl-4 col-lg-6 col-md-6 col-sm-12">
                        <div class="inner-box">
                            <div class="image-box">
                            <div id="chart_div<?php echo e($file->id); ?>" style="width: auto; height: 40vh;"></div>
                            </div>
...
<?php echo $__env->make('layouts.ads', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Umair Zia\Documents\laravel\defenceEstate\resources\views/ads/files.blade.php ENDPATH**/ ?>