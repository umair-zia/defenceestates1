    ...
    <div class="dashboard" style="background-color: #2e2e2e">
	    <div class="container-fluid">
	        <div class="content-area">
	                    			...
	                    			<div class="property-submit-form">
										...
										<div class="title" style="background-color: #2f4f4f"><h3>Basic Info</h3></div>
											...
											<div class="row">
					                            ...
					                            <div class="form-group col-lg-3 col-md-6 col-sm-12 ">
					                                <div class="check-box">
					                                    <input type="checkbox" name="shipping-option[]" id="service-3" value="Constructed Year"> 
					                                    <label for="service-3" style="background: #2e2e2e; color: #FFFFFF">Constructed Year</label>
					                                </div>
					                            </div>

					                            <div class="form-group col-lg-3 col-md-6 col-sm-12 ">
					                                <div class="check-box">
					                                    <input type="checkbox" name="shipping-option[]" id="service-4" value="Bedrooms"> 
					                                    <label for="service-4" style="background: #2e2e2e; color: #FFFFFF">Bedrooms</label>
					                                </div>
					                            </div>

					                            <div class="form-group col-lg-3 col-md-6 col-sm-12 ">
					                                <div class="check-box">
					                                    <input type="checkbox" name="shipping-option[]" id="service-5" value="Kitchens"> 
					                                    <label for="service-5" style="background: #2e2e2e; color: #FFFFFF">Kitchens</label>
					                                </div>
					                            </div>
	            ...
	            <p class="copyright-text">© Azetecs <a href="#"></a> All right reserved.</p>
	        </div>
	    </div>
	</div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Umair Zia\Documents\laravel\defenceEstate\resources\views/admin/update.blade.php ENDPATH**/ ?>