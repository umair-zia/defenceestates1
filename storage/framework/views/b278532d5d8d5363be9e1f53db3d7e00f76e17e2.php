...
<div class="page-wrapper">
        ...
        <div class="header-top">
            <div class="auto-container">
                <div class="inner-container clearfix">
                    ...
                    <div class="top-right">
                        <div class="btn-box"><a href="<?php echo e(route('ads.create')); ?>" class="theme-btn btn-style-four" style="background: #2f4f4f;">Submit Property</a></div>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="row">
                                    ...
                                    <!-- <div class="form-group col-lg-3 col-md-6 col-sm-12">
                                        <div class="range-slider-one clearfix">
                                            ...
                                            <div class="title" style="color: #FFFFFF">Marla</div>
                                        </div>
                                    </div> -->
                                    ...
                                    <!-- <div class="form-group col-lg-3 col-md-6 col-sm-12">
                                        <div class="range-slider-one clearfix">
                                            ...
                                            <div class="title" style="color: #FFFFFF">PK (RS)</div>
                                        </div>
                                    </div> -->
                    ...
                    <div class="inner-box" style="border: solid grey 3px; padding: 5px 5px;">
                        ...
                        <div class="lower-content">
                            ...
                            <ul class="property-info clearfix">
                                <li style="color: #FFFFFF"><i class="flaticon-dimension"></i><?php echo e($ad->area); ?> <?php echo e($ad->unit); ?>
                                    ...
                                    <sup>
                                        ...
                                        data-content="Marla: (<?php echo e(2+2); ?>)">
                                        </a>
                                    </sup>
                                    <?php endif; ?>
                                    <?php endif; ?>
    ...
    <section class="property-section" style="background: #2e2e2e">
        <div class="auto-container">
            ...
            <div class="row">
                <?php $__currentLoopData = $ads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($ad->category == 'Homes' or $ad->category == 'Homes' ): ?>    
                    <!-- Property Block -->
                    <div class="property-block col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box" style="border: solid grey 3px; padding: 5px 5px;">
                            <div class="image-box">
                            ...
                            <div class="lower-content">
                                ...
                                <ul class="property-info clearfix">
                                    <li style="color: #FFFFFF"><i class="flaticon-dimension"></i><?php echo e($ad->area); ?> <?php echo e($ad->unit); ?></li>
                                    <li style="color: #FFFFFF"><i class="flaticon-dimension"></i><?php echo e($ad->city); ?></li>
                                </ul>
                                <div class="property-price clearfix">
                                    <div class="read-more"><a href="<?php echo e(route('ads.show',['id' => $ad->id ])); ?>" class="theme-btn">More Detail</a></div>
                                    <div class="price">Rs. <?php echo e($ad->demand); ?></div>
                ...
                <div class="popular-item masonry-item small-item">
                    <div class="image-box">
                        ...
                        <div class="info-box">
                            ...
                            <h3 class="place"><a  href="<?php echo e(route('findByLocation',['Hyderabad'])); ?>">Hyderabad</a></h3>
                            <!-- <div class="properties"><a href="#">12 Properties</a></div> -->
                            <div class="view-all"><a href="<?php echo e(route('findByLocation',['Hyderabad'])); ?>">View All</a></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="popular-item masonry-item small-item">
                    <div class="image-box">
                        ...
                        <div class="info-box">
                            ...
                            <h3 class="place"><a href="<?php echo e(route('findByLocation',['Faisalabad'])); ?>">Faisalabad</a></h3>
                            <!-- <div class="properties"><a href="#">6 Properties</a></div> -->
                            <div class="view-all"><a href="<?php echo e(route('findByLocation',['Faisalabad'])); ?>">View All</a></div>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH /home/blackfire/Desktop/proj_05/defenceEstate1 (copy)/resources/views/index.blade.php ENDPATH**/ ?>