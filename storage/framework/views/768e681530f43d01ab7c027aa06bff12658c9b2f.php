										    ...
										    <input type="hidden" value="yes" name="aproved">
                                                <div class="title" style="background-color: #2f4f4f"><h3>Basic Info</h3></div>
                                                    <div class="row">
                                                        ...
                                                        <!-- Form Group -->
                                                        <div class="form-group col-lg-3 col-md-6 col-sm-12">
                                                            <button type="submit" class="theme-btn btn-style-one" style="background: #2f4f4f;">Add File</button>
                                                        </div>
                                                        ...
                                                        <tbody>
                                                            <?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <a class="theme-btn btn-style-one" href="<?php echo e(route('files.show',[$file->id])); ?>" style="padding: 5px 15px; background: #2f4f4f;">Add</a>
                                                                                <a class="theme-btn btn-style-one ml-1" href="<?php echo e(route('files.edit',[$file->id])); ?>" style="padding: 5px 15px; background: #2f4f4f;"> Edit</a>
                                                                                <form class="ml-1"  style="display:inline;color: #FFFFFF" action="<?php echo e(route('files.destroy',[$file->id])); ?>" method="POST">
                                                                                    <?php echo csrf_field(); ?>
                                                                                    <?php echo method_field('DELETE'); ?>
                                                                                    <button type="submit" class="theme-btn btn-style-one " style="padding: 5px 15px; background: #2f4f4f;"> Delete</button>
                                                                                </form>
                                                                            </td>
                                                                        </tr>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\22-10-20\defenceEstate1\resources\views/admin/submit-file.blade.php ENDPATH**/ ?>