            ...
            <div class="mixitup-gallery">
                <div class="upper-box clearfix">
                    ...
                    <div class="filters col-md-3">
                        <input class="form-group" type="text"  placeholder="Search" name="phase" style="position: relative; display: block; width: 100%; line-height: 28px; padding: 10px 20px; height: 50px;font-size: 14px; border: 1px solid #e0e0e0; border-radius: 6px;">
                    </div>
                                ...
                                <div class="inner-box" style="border: solid grey 3px; padding: 5px 5px;">
                                    ...
                                    <div class="lower-content">
                                        ...
                                        <ul class="property-info clearfix">
                                            <li style="color: #FFFFFF"><i class="flaticon-dimension"></i><?php echo e($file->area); ?> <?php echo e($file->unit); ?><sup><a class="la la-info-circle" data-toggle="popover" title="Area Conversion" data-content="Marla: (Some Values)"> </a></sup></li>
...
<?php echo $__env->make('layouts.ads', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\defenceEstate1\resources\views/ads/files.blade.php ENDPATH**/ ?>