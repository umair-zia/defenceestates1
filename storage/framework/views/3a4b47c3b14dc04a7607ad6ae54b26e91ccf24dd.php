            ...
            <div class="upper-right">
                <ul class="clearfix">
                    <li class="dropdown option-box">
                        <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" style="color: #FFFFFF"> <img src="<?php echo e(asset('images/admin1.png')); ?>" alt="avatar" class="thumb"><?php echo e($user->name ?? "no name"); ?></a>
...
<!--                    </li>--> 
    ...
    <section class="hidden-bar">
        <div class="dashboard-inner">
        	...
        	<ul class="navigation">
	            <li><a href="<?php echo e(route('admin.index')); ?>"><i class="pe-7s-culture"></i> Dashboard</a></li>
...
</html><?php /**PATH /home/blackfire/Desktop/PROJECTS/proj_04/new/defenceEstate1/resources/views/layouts/admin.blade.php ENDPATH**/ ?>