...
<div class="page-wrapper">
        ...
        <div class="header-top">
            <div class="auto-container">
                <div class="inner-container clearfix">
                    ...
                    <div class="top-right">
                        <div class="btn-box"><a href="<?php echo e(route('login')); ?>" class="theme-btn btn-style-four" style="background: #2f4f4f;">Submit Property</a></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="property-section" style="background: #2e2e2e">
        <div class="auto-container">
            ...
            <div class="row">
                <?php $__currentLoopData = $ads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($ad->category == 'Commercial' or $ad->category == 'Commercial' ): ?>    
                    <!-- Property Block -->
                    <div class="property-block col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box" style="border: solid grey 3px; padding: 5px 5px;">
                            <?php $__currentLoopData = json_decode($ad->images); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\xampp\htdocs\Laravel\22-10-20\defenceEstate1\resources\views/index.blade.php ENDPATH**/ ?>