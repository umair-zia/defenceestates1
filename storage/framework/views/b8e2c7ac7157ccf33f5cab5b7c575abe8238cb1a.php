...
<div class="page-wrapper">
                            ...
                            <nav class="main-menu navbar-expand-md navbar-light">
                                ...
                                <div class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li><a href="https://maps.dhalahore.org/" target="_blank" style="color: #FFFFFF;">DHA GIS Map</a></li>
                    ...
                    <nav class="main-menu">
                        <div class="navbar-collapse show collapse clearfix">
                            <ul class="navigation clearfix">
                                ...
                                <li><a href="https://maps.dhalahore.org/" target="_blank" style="color: #FFFFFF;background-color: transparent">DHA GIS Map</a></li>
                                <li><a href="<?php echo e(route('forms')); ?>" style="color: #FFFFFF;">Forms</a></li>
                        ...
                        <div class="property-search-form">
                            <form method="post" action="index.html">
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-sm-12">
			                            <label style="color: #FFFFFF">Category</label>
			                                <select name="type" id="mySelect1" onchange="myFunction1()" >
		                                        <option value="">Category</option>
		                                        <option value="Homes">Homes</option>
		                                        <option value="Commercial">Commercial</option>
                                                <option value="Appartment">Appartment</option>
    ...
    <section class="property-section mt-1" style="background: #2e2e2e">
        <div class="auto-container">
            <div class="sec-title">
                <span class="title">FIND YOUR PLOT</span>
                <h2 style="color: #FFFFFF">RECENT PLOTS</h2>
            </div>
...
<?php /**PATH /home/xxx/Desktop/php/defenceEstate1/defenceEstate1/resources/views/index.blade.php ENDPATH**/ ?>