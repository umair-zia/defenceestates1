                    ...
                    <div class="top-left">
                        <ul class="contact-list clearfix">
                            <li><i class="la la-home"></i> A-45 Commercial, Phase 6 DHA,
                                Lahore, Pakistan</li>
                            <li><i class="la la-envelope-o"></i><a href="mailto:info@defenceestate.com">info@defenceestate.com
                            </a></li>
                        </ul>
                    </div>
                    <div class="top-right">
                        <div class="btn-box"><a href="{{ route('admin.index') }}" class="theme-btn btn-style-four">Submit Property</a></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="header-lower">
            <div class="main-box">
                <div class="auto-container">
                    <div class="inner-container clearfix">
                        <div class="logo-box">
                            <div class="logo"><a href="{{ route('index') }}"><img src="{{asset('images/2.png')}}" alt="" title=""></a></div>
                        </div>
                            ...
                            <nav class="main-menu navbar-expand-md navbar-light">
                                ...
                                <div class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li><a href="{{ route('ads.index') }}">Properties</a></li>
        ...
        <div class="sticky-header">
            <div class="auto-container clearfix">
                ...
                <div class="logo pull-left">
                    <a href="{{ route('index') }}" title=""><img src="{{asset('images/2.png')}}" alt="" title=""></a>
                </div>
                <!--Right Col-->
    ...
    <section class="property-section">
        <div class="auto-container">
                ...
                <div class="property-block col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box">
                        ...
                        <div class="lower-content">
                            ...
                            <div class="lucation"><i class="la la-map-marker"></i>{{ $ad->adress }}</div>
                            <ul class="property-info clearfix">
                            @if ($ad->unit == 'Marla')
                            <li><i class="flaticon-dimension"></i>{{ $ad->area }} Marla
                                @else
                                    @if ($ad->unit != 'Marla')
                                        @if ($ad->unit == 'Square Feet')
                                        <li><i class="flaticon-dimension"></i>{{ round($ad->area/225, 2) }} Marla
                                            <sup>
                                        ...
                                        <li><i class="flaticon-dimension"></i>{{ round($ad->area/25, 2) }} Marla
                                            <sup>
                                                <a class="la la-info-circle" 
                                                data-toggle="popover" 
                                                title="Area Conversion" 
                                        ...
                                        <li><i class="flaticon-dimension"></i>{{ round($ad->area/20.9, 2) }} Marla
                                            <sup>
                                                <a class="la la-info-circle" 
                                                data-toggle="popover" 
                                                title="Area Conversion" 
                                        ...
                                        @endif
                                        @if ($ad->unit == 'Kanal')
                                        <li><i class="flaticon-dimension"></i>{{ $ad->area*20 }} Marla
                                            <sup>
                                                <a class="la la-info-circle" 
                                                data-toggle="popover" 
                                                title="Area Conversion" 
                                ...
                                <li><i class="flaticon-bed"></i> {{ $ad->bedroom }} Bedrooms</li>
                                <li><i class="flaticon-full-screen"></i> {{ $ad->kitchen }} Kitchen</li>
                                <li><i class="flaticon-bathtub"></i> {{ $ad->bathroom }} Bathroom</li>
                            </ul>
                            <div class="property-price clearfix">
                                <div class="read-more"><a href="{{route('ads.show',['id' => $ad->id ])}}" class="theme-btn btn-style-two">More Detail</a></div>
            ...
            <div class="load-more-btn text-center">
                <a href="{{ route('ads.index') }}" class="theme-btn btn-style-two">Load More</a>
            </div>
    ...
    <section class="property-section">
        <div class="auto-container">
            <div class="sec-title">
                ...
                <h2>RECENT COMMERCIAL PROPERTIES</h2>
            </div>
    ...
    <section class="property-section">
        <div class="auto-container">
            <div class="sec-title">
                ...
                <h2>RECENT RESIDENTIAL PROPERTIES</h2>
            </div>
            ...
            <div class="row">
                ...
                <div class="info-column col-xl-6 col-lg-12 col-md-12 col-sm-12">
                    <div class="inner-column">
                        ...
                        <div class="text"><strong>DEFENCE REAL ESTATE</strong> is the best place for buying beatiful apartments, houses, flats in Pakistan within the best prices.</div>
                ...
                <div class="video-column col-xl-6 col-lg-7 col-md-12 col-sm-12">
                    <div class="inner-column">
                        <div class="video-box">
                            <figure class="image"><img src="{{asset('images/property/6.jpg')}}" alt=""></figure>
        ...
        <div class="auto-container">
            ...
            <div class="masonry-items-container clearfix">
                ...
                <div class="popular-item masonry-item medium-item">
                    <div class="image-box">
                        <figure class="image"><img src="{{asset('images/property/4.jpg')}}" alt=""></figure>
                        <div class="info-box">
                            <h3 class="place"><a href="{{ route('findByLocation',['Lahore']) }}">Lahore</a></h3>
                            <div class="view-all"><a href="{{ route('findByLocation',['Lahore']) }}">View All</a></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="popular-item masonry-item medium-item">
                    <div class="image-box">
                        <figure class="image"><img src="{{asset('images/property/7.jpg')}}" alt=""></figure>
                        <div class="info-box">
                            <h3 class="place"><a href="{{ route('findByLocation',['Islamabad']) }}">Islamabad</a></h3>
                            <div class="view-all"><a href="{{ route('findByLocation',['Islamabad']) }}">View All</a></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="popular-item masonry-item medium-item">
                    <div class="image-box">
                        <figure class="image"><img src="{{asset('images/property/6.jpg')}}" alt=""></figure>
                        <div class="info-box">
                            <h3 class="place"><a href="{{ route('findByLocation',['Karachi']) }}">Karachi</a></h3>
                            <div class="view-all"><a href="{{ route('findByLocation',['Karachi']) }}">View All</a></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="popular-item masonry-item small-item">
                    <div class="image-box">
                        <figure class="image"><img src="{{asset('images/property/14.jpg')}}" alt=""></figure>
                        <div class="info-box">
                            <h3 class="place"><a  href="{{ route('findByLocation',['Bahawalpur']) }}">Bahawalpur</a></h3>
                            <div class="view-all"><a href="{{ route('findByLocation',['Bahawalpur']) }}">View All</a></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="popular-item masonry-item small-item">
                    <div class="image-box">
                        <figure class="image"><img src="{{asset('images/property/12.jpg')}}" alt=""></figure>
                        <div class="info-box">
                            <h3 class="place"><a href="{{ route('findByLocation',['Peshawar']) }}">Peshawar</a></h3>
                            
                            <div class="view-all"><a href="{{ route('findByLocation',['Peshawar']) }}">View All</a></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="auto-container">
            <div class="clearfix">
                ...
                <div class="button-column">
                    <a href="{{ route('ads.create') }}" class="theme-btn btn-style-three">SUBMIT PROPERTY</a>
                    <a href="{{ route('ads.index') }}" class="theme-btn btn-style-one">BROWSE PROPERTY</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="auto-container">
            ...
            <div class="agents-carousel owl-carousel owl-theme">
                ...
                <div class="agent-block">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image"><a href="agent-detail.html"><img src="{{asset('images/team-1.jpg')}}" alt=""></a></figure>
                ...
                <div class="row">
                    ...
                    <div class="upper-column col-lg-3 col-md-12 col-sm-12">
                        <div class="footer-logo">
                            <figure class="image"><a href="{{asset('images/2.png')}}"><img src="{{asset('images/2.png')}}" alt=""></a></figure>
                        </div>
                    </div>
                                ...
                                <div class="footer-widget cities-widget">
                                    ...
                                    <div class="widget-content">
                                        <ul class="list clearfix">
                                            <li><a  href="{{ route('findByLocation',['Karachi'])    }}">Karachi</a></li>
                                            <li><a  href="{{ route('findByLocation',['Multan'])     }}">Multan</a></li>
                                            <li><a  href="{{ route('findByLocation',['Gujranwala']) }}">Gujranwala</a></li>
                                            <li><a  href="{{ route('findByLocation',['Lahore'])     }}">Lahore</a></li>
                                            <li><a  href="{{ route('findByLocation',['Bahawalpur']) }}">Bahawalpur</a></li>
                                            <li><a  href="{{ route('findByLocation',['Peshawar'])   }}">Peshawar</a></li>
        ...
        <div class="footer-bottom">
            <div class="auto-container">
                ...
                <div class="inner-container clearfix">
                    ...
                    <p class="copyright-text">© 2020 <a href="http://defenceestate.com/">Defence Estate</a> All right reserved.</p>
                    </div>
                </div>
                </div>
            </div>
