	                    	...
	                    	<div class="properties-box">
	                    		<div class="inner-container">
	                    			<div class="property-submit-form">
			                            <form action="{{ route('admin.updateProperty', ['id' => $ad->id]) }}" method="POST" enctype="multipart/form-data">
										 @csrf
										...
										<div class="title" style="background-color: #2f4f4f"><h3>Basic Info</h3></div>
			                                <div class="row">
			                                    ...
			                                    <div class="form-group col-lg-3 col-md-6 col-sm-12">
			                                        ...
			                                        <input type="text"  placeholder="Property Title" name="title" value="{{$ad->title}}" required>
			                                    </div>
												...
												<div class="form-group col-lg-3 col-md-6 col-sm-12">
													<div class="range-slider-one clearfix">
														...
														<input type="text"  placeholder="Ruppees PKR" name="demand" value="{{$ad->demand}}" required>
													</div>
												</div>
												...
												<div class="form-group col-lg-3 col-md-6 col-sm-12">
													<div class="range-slider-one clearfix">
														...
														<input type="text"  placeholder="Area" name="area" value="{{$ad->area}}" required>
													</div>
												</div>
			                                ...
			                                <div class="row">
			                                    ...
			                                    <div class="form-group col-lg-6 col-md-6 col-sm-12">
			                                        ...
			                                        <input type="text" name="adress" placeholder="Address" value="{{$ad->adress}}" required>
			                                    </div>
			                                    ...
			                                    <div class="form-group col-lg-3 col-md-6 col-sm-12">
			                                        ...
			                                        <input type="text" name="postal" placeholder="Postal Code" value="{{$ad->postal}}" required>
			                                    </div>
			                                ...
			                                <div class="row col-lg-12 col-md-12 col-sm-12">
												...
												<div class="custom-file pmd-custom-file">
			                                        ...
			                                        {{-- <!-- <div id="myDropZone" class="dropzone dropzone-design">
														...
														<input type="file" name="photos[]" id="img" multiple="multiple" accept="image/*">
													</div> --> --}}
													...
													{{-- <div class="form-group col-lg-12 col-md-12 col-sm-12">
														<div id="myDropZone" class="dropzone dropzone-design" style="background-color: #969695; color: white;">
															<div class="dz-default dz-message" name="img"><span>Drop files here to upload</span></div>
														</div>
													</div> --}}
			                                ...
			                                <div class="row">
			                                    ...
			                                    <div class="form-group col-lg-12">
			                                    	<textarea name="detail" placeholder="Detailed Information" >{{$ad->detail}}</textarea>
			                                    </div>
			                                </div>
			                                ...
			                                <div class="row">
			                                    ...
			                                    <div class="form-group col-lg-3 col-md-6 col-sm-12">
			                                        ...
			                                        <input type="text" name="name" value="{{$ad->name}}" placeholder="Name" required>
			                                    </div>

			                                    <!-- Form Group -->
			                                    <div class="form-group col-lg-3 col-md-6 col-sm-12">
			                                        <label style="color: #FFFFFF">Email</label>
			                                        <input type="email" name="email" value="{{$ad->email}}" placeholder="Email" required>
			                                    </div>

												<!-- Form Group -->
												<div class="form-group col-lg-3 col-md-6 col-sm-12">
													<label style="color: #FFFFFF">Phone Number</label>
													<input type="text" name="phone" value="{{$ad->phone}}" placeholder="Phone Number" required>
												</div>
												...
												@foreach ($ad->features as $feature)
													<input type="hidden" name="option[]" value="{{$feature}}">
												@endforeach
			                                    <!-- Form Group -->
			                                    <div class="form-group col-lg-3 col-md-6 col-sm-12">
