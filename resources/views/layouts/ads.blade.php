                ...
                <div class="inner-container clearfix">
                    ...
                    <div class="top-right clearfix">
                        <ul class="clearfix">
                            ...
                            <li><a href="{{ route('login') }}" style="color: #FFFFFF">Register</a></li>
                        </ul>
                        <div class="btn-box">
                            <a href="{{ route('admin.index') }}" class="theme-btn btn-style-two" class="theme-btn btn-style-two" style="background: #2f4f4f">Dashboard</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="pull-right">
                    ...
                    <nav class="main-menu">
                        <div class="navbar-collapse show collapse clearfix">
                            <ul class="navigation clearfix">
                                <li><a href="{{ route('index') }}" style="color: #FFFFFF;background-color: transparent">Home</a></li></li>
                                <li><a href="{{ route('about') }}" style="color: #FFFFFF;background-color: transparent">About</a></li>
                                <li><a href="{{ route('ads.index') }}" style="color: #FFFFFF;background-color: transparent">Properties</a></li>
                                <li><a href="{{ route('files') }}"style="color: #FFFFFF;background-color: transparent">Files</a></li>
                                <li><a href="{{ route('contact') }}" style="color: #FFFFFF;background-color: transparent">Contact</a></li>
                                ...
                                <li><a href="{{ route('forms') }}" style="color: #FFFFFF;background-color: transparent">Forms</a></li>
                            </ul>
                        </div>
                    </nav>
                    <!-- Main Menu End-->
                ...
                <div class="row">
                    ...
                    <div class="upper-column col-lg-3 col-md-12 col-sm-12">
                        <div class="footer-logo">
                            <figure class="image"><a href="{{ route('index') }}"><img src="{{asset('images/2.png')}}" alt=""></a></figure>
                        </div>
                    </div>
